function pieceOfPie(arr, firstTaste, secondTaste) {

    let indexOfFirstTaste = arr.indexOf(firstTaste);
    let indexOfSecondTaste = arr.indexOf(secondTaste);
    let result = arr.slice(indexOfFirstTaste, indexOfSecondTaste + 1);
    return result;
